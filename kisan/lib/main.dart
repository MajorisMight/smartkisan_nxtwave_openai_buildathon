...
Future<void> main() async {
  ...
  await Supabase.initialize(
    url: 'https://wiwezsrdsrszpzgjdxxj.supabase.co',
    anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Indpd2V6c3Jkc3JzenB6Z2pkeHhqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTg0Mjc2NDQsImV4cCI6MjA3NDAwMzY0NH0.BMlR7rkqv4GpxaokrKPtorHqtYZ-ud_nQ5Xi1Hv6i8Y',
    ...
    _router = GoRouter(
      ...
      redirect: (BuildContext context, GoRouterState state) async {
        ...
        if (user.emailConfirmedAt == null) {
          print('User exists but email not confirmed - staying on current page');
          return null;
        }
